...
<body onload="check()">
	...
	<header class="cd-main-header">
		<a href="admin.php" class="cd-logo"><img src="images/somaiya.png" alt="Logo"></a>
		...
		<nav class="cd-nav">
			<ul class="cd-top-nav">
				...
				<li class="has-children account">
					...
					<ul>
						<li><a href="settingsadmin.php">Edit Account</a></li>
		...
		<nav class="cd-side-nav">
			<ul>
				...
				<li class="profile active">
					<a href="admin.php?user=<?php echo $_SESSION['login_user'];?>">Profile</a>
				</li>

				<li class="messages">
					<a href="inboxadmin.php">Messages<span class="count" id="msgcount"></span></a>
				</li>
				...
				<div class="info-box">
					...
					<div class="pro-title">
	            		<center><img class="profile-image" src="<?php echo $dp; ?>">
	            		 ...
	            		 <input value="<?php echo  $id?>" id="user" name="user" hidden>
	            ...
	            <div class="pro-education student">
    	        	...
    	        	<center>
						...
						<?php
												...
												$inst_table = mysqli_query($conn, $inst_query);
												if ($inst_table){
												...
												$deg_table = mysqli_query($conn, $deg_query);
												if ($deg_table){
				...
				if($rows > 0){
				    for($x = 0; $x<= $row; $x++){
						...
						if ($_GET['user'] == $row['contact_id']){
							...
							$("button#add-contact").css({"background-color":"GREEN","border":"1px solid #16b980", "color":"#16b980"});
							<?php
							$_SESSION['added'] = 1;
